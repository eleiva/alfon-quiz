...
export const bd2SectionB: FillQuestion[] = [
  ...
  },
  {
    ...
    question:
      "🪟 En SQL, la cláusula que define el conjunto de filas sobre las que opera una window function se escribe: OVER ( _________ BY columna )\n💡 Pista: empieza con P, tiene 9 letras en inglés. Divide el resultado en particiones para que la función opere dentro de cada grupo.",
    answer: "PARTITION",
  ...
  },
  {
    ...
    category: "Normalización",
    question:
      "🏗️ Una tabla EMPLEADO tiene estos atributos:\n· empleado_id (PK)\n· nombre\n· departamento_id\n· departamento_nombre\n· departamento_ciudad\n\nLas dependencias son:\n· empleado_id → nombre, departamento_id\n· departamento_id → departamento_nombre, departamento_ciudad\n\n¿En qué Forma Normal está este esquema?\n💡 Pista: los datos son atómicos y hay PK, pero departamento_nombre depende de departamento_id, no de empleado_id. Escribí 1FN, 2FN o 3FN.",
    answer: "2FN",
